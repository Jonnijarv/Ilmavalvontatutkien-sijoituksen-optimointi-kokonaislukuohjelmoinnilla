r=[500,350,350,350]; % radii of the radars in km
n = length(r); % # of radars
res = 1; % resolution of the terrain in km^2
maxheights = [30 15 15 15]; % maximum height of the radars in km
...
%options.InitialPopulationRange = [1 445; 17 51; 1 445; 1 445]';
